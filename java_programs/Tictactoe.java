...
public class Main {
	...
	public static int cpuStrategicMove(String[] board) {
		if (board[0].equals(board[1]).equals("X")) && !(board[2].equals("O"))
        	return 2;
	    if (board[1].equals(board[2]).equals("X")) && !(board[0].equals("O"))
	        return 0;
	    if (board[3].equals(board[4]).equals("X")) && !(board[5].equals("O"))
	        return 5;
	    if (board[4].equals(board[5]).equals("X")) && !(board[3].equals("O"))
	        return 3;
	    if (board[6].equals(board[7]).equals("X")) && !(board[8].equals("O"))
	        return 8;
	    if (board[7].equals(board[8]).equals("X")) && !(board[6].equals("O"))
	        return 6;
	    if (board[0].equals(board[3]).equals("X")) && !(board[6].equals("O"))
	        return 6;
	    if (board[3].equals(board[6]).equals("X")) && !(board[0].equals("O"))
	        return 0;
